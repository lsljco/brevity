...
| Settings backup export | Prefix-based localStorage JSON | Browser export + server stores | REPLACE | Settings / Estate admin | Server export manifest, records, hashes and files | Restore drill and checksum validation | Not started |
