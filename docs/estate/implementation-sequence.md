...
4. **Systems, assets and maintenance** — build system/asset registry, preventive plans, generated events/work orders and service history; publish schedule facts to Family Calendar.
