...
const DIRECT_REVIEW_TYPES=new Set(['decision.create','decision.update','assignment.create','assignment.update','plan.overview.update','plan.pillar.update','plan.alignment.update','plan.recap.update','household.schedule.block.create','household.schedule.block.update','household.schedule.block.delete','household.schedule.invitation.update','household.schedule.routine.create','household.schedule.routine.update','household.schedule.routine.delete','household.schedule.occurrence.update','household.maintenance.coverage.update','household.maintenance.exception.update','household.maintenance.completion.update','household.inventory.item.create','household.inventory.quantity.update','household.inventory.waste.create','project.create','project.update','project.delete','transaction.update','transaction.rule.create','transaction.rule.delete','meeting.action.create','meeting.action.update','meeting.correction.create','meeting.correction.update','meeting.session.create','meeting.workspace.update','meeting.history.update','budget.update','forecast.update','finance.account.link','recurring.create','recurring.update','recurring.delete'])
