...
export default async function handler(request){
 ...
 try{
  ...
  const workflow=await readSermonWorkflow(id),hasError=[oneDrive,visuals,devotions].some(value=>value.state==='error')||Object.values(workflow?.stages||{}).some(stage=>stage?.state==='error')
