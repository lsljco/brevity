...
export default function App() {
  ...
  useEffect(()=>{
    ...
    return startSharedStateSync({
      onRemoteChange:keys=>setRefreshState({status:'warning',message:`New household changes were synchronized (${keys.length} record${keys.length===1?'':'s'}). Refresh this view to display them.`,issues:[],expanded:false}),
