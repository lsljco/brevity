...
function SettingsPage({ currentMember, role }) {
  ...
  const backupKeys=['lslj_finance_v9','plaid_actuals_cache','lslj_budget_v1','lslj_actuals_v1','lslj_bal_overrides_v1','lslj_tx_overrides_v1','lslj_tx_rules_v1','brevity_finance_categories_v1','fp_goals','homehq_items_v1','family_calendar_events_v1','brevity_daily_financial_alignment_v1']
