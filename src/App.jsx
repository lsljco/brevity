...
export default function App() {
  ...
  const toggleSidebar=()=>{
    ...
    if(!isCompactNavigation())localStorage.setItem(SIDEBAR_STATE_KEY,next?'expanded':'collapsed')
    setSidebarExpanded(next)
  }
  const handleSidebarPointerUp=event=>{
    event.stopPropagation()
    if(event.pointerType)toggleSidebar()
  }
