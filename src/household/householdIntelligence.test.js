...
test('Today intelligence combines member work, inventory risk, waste, and projected obligations', () => {
  ...
  const estateWorkspace={maintenancePlans:[{id:'plan',title:'HVAC service',expectedCost:107}],maintenanceEvents:[{id:'event',maintenancePlanId:'plan',scheduledFor:'2026-09-05',status:'due'}],workOrders:[]}
  const model = buildUnifiedHouseholdIntelligence({ storage:storage(records), currentMember:'Nyla', today, estateWorkspace })
