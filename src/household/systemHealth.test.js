...
test('system health uses a bundle-safe storage import',()=>{const source=fs.readFileSync(new URL('../../netlify/functions/system-health.mjs',import.meta.url),'utf8');assert.match(source,/import storage from '\.\/storage\.js'/);assert.doesNotMatch(source,/createRequire|import\.meta\.url/)})
