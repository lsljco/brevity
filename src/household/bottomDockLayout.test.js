...
test('desktop and tablet reserve a real viewport lane for Ask Brevity', () => {
  ...
  assert.match(css, /@media\(min-width:641px\) and \(max-width:1180px\)/)
  const tablet = css.slice(css.indexOf('@media(min-width:641px) and (max-width:1180px)'), css.indexOf('/* Phone:'))
