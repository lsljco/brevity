...
.finance-root {
  ...
  background:
    linear-gradient(90deg, rgba(0,0,0,.92) 0%, rgba(6,7,7,.74) 32%, rgba(5,7,8,.90) 100%),
    radial-gradient(circle at 68% 4%, rgba(197,164,109,.16), transparent 32%),
    radial-gradient(circle at 7% 88%, rgba(197,164,109,.10), transparent 34%),
    url('https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=2200&q=90&auto=format&fit=crop') center center / cover fixed,
    #050505 !important;
}
...
.kpi-icon i { font-size: 20px !important; stroke-width: 1.4 !important; }
.kpi-label {
...
.kpi-value {
  margin: 0 !important;
  color: var(--brevity-white) !important;
  font-size: clamp(29px, 2.1vw, 42px) !important;
...
.kpi-sub {
  ...
  color: rgba(216,209,196,.74) !important;
...
.dash-main-grid {
  display: grid !important;
  grid-template-columns: 1.02fr 1.02fr 1.95fr !important;
...
@media (max-width: 1450px) {
  ...
  .kpi-card { padding: 20px 20px 16px !important; height: 170px !important; }
  .kpi-value { font-size: clamp(25px, 2vw, 34px) !important; }
  .kpi-sparkline { left: 20px !important; right: 20px !important; bottom: 38px !important; }
  .dash-main-grid { grid-template-columns: 1fr 1fr 1.55fr !important; gap: 14px !important; }
...
export default function FinancePlanner({ view: extView, setView: setExtView }) {
  ...
  const ROOM_IMGS = {
    Kitchen:      'https://images.unsplash.com/photo-1615873968403-89e068629265?w=500&h=300&fit=crop&q=90',
    ...
    Yard:         'https://images.unsplash.com/photo-1600607688969-a5bfcd646154?w=500&h=300&fit=crop&q=90',
